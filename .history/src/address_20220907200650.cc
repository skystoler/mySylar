...
IPAv6ddress::ptr IPv6Address::networkAddress(uint32_t prefix_len){

}

IPAv6ddress::ptr IPv6Address::subnetMask(uint32_t prefix_len){
...
UnixAddress::UnixAddress(const std::string& path){
    ...
    m_length+=offset(sockaddr_un,sun_path);
}
