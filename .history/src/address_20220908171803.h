...
public:
    ...
    IPv4Address::ptr broadcastAddress(uint32_t prefix_len) override;
    IPv4Address::ptr networkAddress(uint32_t prefix_len) override;
    IPv4Address::ptr subnetMask(uint32_t prefix_len) override;
...
public:
    ...
    IPv6Address::ptr broadcastAddress(uint32_t prefix_len) override;
    IPv6Address::ptr networkAddress(uint32_t prefix_len) override;
    IPv6Address::ptr subnetMask(uint32_t prefix_len) override;
