...
using read_fun=ssize_t(*)(int fd, const struct iovec *iov, int iovcnt);
extern readv_fun readv_f;

using read_fun=ssize_t(*)(int sockfd, void *buf, size_t len, int flags);
extern recv_fun recv_f;

using read_fun=ssize_t(*)(int sockfd, void *buf, size_t len, int flags, struct sockaddr *src_addr, socklen_t *addrlen);
extern recvfrom_fun recvfrom_f;

using read_fun=ssize_t(*)(int sockfd, struct msghdr *msg, int flags);
extern recvmsg_fun recvmsg_f;

//write
using read_fun=ssize_t(*)(int fd, const void *buf, size_t count);
extern write_fun write_f;

using read_fun=ssize_t(*)(int fd, const struct iovec *iov, int iovcnt);
extern writev_fun writev_f;

using read_fun=ssize_t(*)(int s, const void *msg, size_t len, int flags);
extern send_fun send_f;

using read_fun=ssize_t(*)(int s, const void *msg, size_t len, int flags, const struct sockaddr *to, socklen_t tolen);
extern sendto_fun sendto_f;

using read_fun=ssize_t(*)(int s, const struct msghdr *msg, int flags);
