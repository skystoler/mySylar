...
static sylar::Logerr::ptr g_logger=SYLAR_LOG_ROOT();
...
static sylar::ConfigVar<uint64_t>::ptr g_http_max_body_size=
...
static uint64_t s_http_reuest_max_body_size=g_http_max_body_size->getValue();
